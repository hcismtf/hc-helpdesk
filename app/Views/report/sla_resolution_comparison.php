<?php
// app/Views/report/sla_resolution_comparison.php
?>

<div class="container mt-5">
    <div class="row">
        <div class="col-md-12">
            <h2>SLA Resolution Time Comparison Report</h2>
            
            <!-- Filter Form -->
            <div class="card mb-4">
                <div class="card-body">
                    <form method="GET" action="<?= site_url('admin/report/sla-resolution') ?>" class="row g-3">
                        <div class="col-md-4">
                        ...
                        <tbody>
                            <?php foreach ($data as $row): ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= isset($row['avg_resolution_hours']) ? round($row['avg_resolution_hours'], 2) : '-' ?></td>
                                    <td><?= isset($row['min_resolution_hours']) ? round($row['min_resolution_hours'], 2) : '-' ?></td>
                                    <td><?= isset($row['max_resolution_hours']) ? round($row['max_resolution_hours'], 2) : '-' ?></td>
                                    <td><?= $total ?></td>
