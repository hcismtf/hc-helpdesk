<div id="global-invalid-confirm" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; z-index:99999; background:rgba(0,0,0,0.12); align-items:center; justify-content:center; backdrop-filter: blur(4px);">
